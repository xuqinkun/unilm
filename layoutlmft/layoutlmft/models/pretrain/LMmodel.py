...
from layoutlmft.models.layoutlmv2.modeling_layoutlmv2 import \
    (LayoutLMv2Model, LayoutLMv2PreTrainedModel, PrefixEncoder)
import  torch
...
class LayoutLMv2ForTokenClassification(LayoutLMv2PreTrainedModel):
    ...
    def forward(
        ...
        ############################################################### MVLM loss
        #print('---------------loss1-----------------------')
        #print(input_ids,tokens,mvlm_mask)
        ...
        loss2=loss_fct(Aactive_logits,Aactive_labels)
        #print(loss2)
        #######################################################
        #print('---------------loss3-----------------------')
        Mactive_logits=Mlogits.view(-1,2)
        Mactive_labels=match_label.view(-1)
        loss3=loss_fct(Mactive_logits,Mactive_labels)
        ##############################################################
