...
LABEL_MAP = {"合同号": "CONTRACT_ID", "甲方": "FIRST_PARTY", "乙方": "SECOND_PARTY", "总金额": "AMOUNT", "日期": "DATE"}


class XContractConfig(datasets.BuilderConfig):

    def __init__(self, lang, addtional_langs=None, **kwargs):
        super(XContractConfig, self).__init__(**kwargs)
        self.lang = lang
        self.addtional_langs = addtional_langs


class XContract(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [XContractConfig(name=f"xcontract.{lang}", lang=lang) for lang in _LANG]

    tokenizer = AutoTokenizer.from_pretrained("xlm-roberta-base")

    def __init__(self, **kwargs):
        super(XContract, self).__init__(**kwargs)
            ...
            features=datasets.Features(
                {
                    ...
                    "labels": datasets.Sequence(
                        datasets.features.ClassLabel(
                            names=["O", "B-CONTRACT_ID", "B-FIRST_PARTY", "B-SECOND_PARTY", "B-AMOUNT", "B-DATE",
                                   "I-CONTRACT_ID", "I-FIRST_PARTY", "I-SECOND_PARTY", "I-AMOUNT", "I-DATE", ]
                        )
                    ),
                    ...
                    "entities": datasets.Sequence(
                        {
                            ...
                            "label": datasets.ClassLabel(names=["CONTRACT_ID", "FIRST_PARTY", "SECOND_PARTY", "AMOUNT",
                                                                "DATE"]),
                        }
                    ),
                }
