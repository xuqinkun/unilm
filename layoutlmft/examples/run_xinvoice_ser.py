...
from layoutlmft.data.datasets.xinvoice import LABEL_MAP as label_map
...
from utils import do_predict, error_analysis, output_pred, load_model
...
def main():
    ...
    if training_args.do_predict:
        ...
        pred_cloze_map = do_predict(label_list, test_dataset, id_to_word, true_predictions,
                                    train_dataset=datasets["train"], full_doc=True)
